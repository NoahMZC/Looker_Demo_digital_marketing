  ...
  derived_table: {
    ...
    ,
      ...
      *,
      ...
      JOIN mzcdsc-team-200716.Looker_Demo_ecomm.order_items on order_items.created_at = events.created_at
      --JOIN mzcdsc-team-200716.Looker_Demo_ecomm.inventory_items  AS inventory_items ON inventory_items.id = order_items.inventory_item_id
